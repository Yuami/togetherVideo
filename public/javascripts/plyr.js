!function (e, t) {
    ...
    "use strict";
    var e = {html5: "html5", youtube: "youtube", vimeo: "vimeo"}, t = {audio: "audio", video: "video"}, i = {
        enabled: !0,
        title: "",
        debug: !1,
        autoplay: !1,
        ...
        captions: {active: !1, language: (navigator.language || navigator.userLanguage).split("-")[0]},
        ...
        urls: {
            ...
            googleIMA: {api: "https://imasdk.googleapis.com/js/sdkloader/ima3.js"}
        },
        listeners: {
            seek: null,
            play: null,
    ...
    var n, s, a = (function (e, t) {
        ...
        i = function () {
            ...
            function l(t, i, n, s) {
                var a, r, o = document, c = n.async, u = (n.numRetries || 0) + 1, d = n.before || e,
                    p = t.replace(/^(css|img)!/, "");
            ...
            function r(e, i, n) {
                ...
                !function (e, t, i) {
                    var n, s, a = (e = e.push ? e : [e]).length, r = a, o = [];
            ...
            return r.ready = function (e, t) {
                return function (e, t) {
                    var s, a, l, r = [], o = (e = e.push ? e : [e]).length, c = o;
                    for (s = function (e, i) {
    ...
    }(n = {exports: {}}, n.exports), n.exports), l = function (e, t) {
        ...
        is: {
            ...
            return new Promise(function (t, i) {
                a(e, {success: t, error: i})
            })
        }, loadSprite: function (e, t) {
            if (u.is.string(e)) {
                var i = u.is.string(t), n = function () {
                ...
                if (!i || !n()) {
                    ...
                    u.fetch(e).then(function (e) {
                        u.is.empty(e) || (d.storage && window.localStorage.setItem("cache-" + t, JSON.stringify({content: e})), r.call(s, e))
                    }).catch(function () {
                    })
                }
            }
            ...
            return e.split(",").forEach(function (e) {
                var t = e.trim(), s = t.replace(".", ""), a = t.replace(/[[\]]/g, "").split("="), l = a[0],
            ...
            if (u.is.element(e)) {
                var i = u.getElements.call(this, "button:not(:disabled), input:not(:disabled), [tabindex]"), n = i[0],
                    s = i[i.length - 1], a = function (e) {
            ...
            if (!u.is.empty(e) && !u.is.empty(t) && u.is.function(i)) if (u.is.nodeList(e) || u.is.array(e)) Array.from(e).forEach(function (e) {
                e instanceof Node && u.toggleListener.call(null, e, t, i, n, s, a)
            }); else {
                var l = t.split(" "), r = a;
                d.passiveListeners && (r = {passive: s, capture: a}), l.forEach(function (t) {
            ...
            if (u.is.element(e) && !u.is.empty(t)) {
                var s = new CustomEvent(t, {
                    bubbles: i,
                    detail: Object.assign({}, n, {plyr: u.is.plyr(this) ? this : null})
                });
                e.dispatchEvent(s)
            }
            ...
            if (u.is.array(e) || u.is.nodeList(e)) Array.from(e).forEach(function (e) {
                ...
                var i = "true" === e.getAttribute("aria-pressed"), n = u.is.boolean(t) ? t : !i;
            ...
            var n = function (e) {
                return ("0" + e).slice(-2)
            }, s = this.getHours(e), a = this.getMinutes(e), l = this.getSeconds(e);
            ...
            return this.is.empty(t) ? null : t.slice(t.indexOf("?") + 1).split("&").reduce(function (e, t) {
                var i = t.split("="), n = c(i, 2), s = n[0], a = n[1];
        ...
        check: function (e, t, i) {
            var n = !1, s = !1, a = u.getBrowser(), l = a.isIPhone && i && d.playsinline;
            switch (t + ":" + e) {
                case"html5:video":
    ...
    var y = function () {
        ...
        return r(e, [{
            ...
            key: "exit", value: function () {
                if (this.enabled) if (m.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(), this.player.play(); else if (e.native) if (this.prefix) {
                    if (!u.is.empty(this.prefix)) {
                        var t = "moz" === this.prefix ? "Cancel" : "Exit";
                        document["" + this.prefix + t + this.property]()
                    }
                } else (document.cancelFullScreen || document.exitFullscreen).call(document); else f.call(this, !1)
            }
        }, {
        ...
        var i = t.i18n[e], n = {"{seektime}": t.seekTime, "{title}": t.title};
        return Object.entries(n).forEach(function (e) {
            var t = c(e, 2), n = t[0], s = t[1];
        ...
        setup: function () {
            if (this.supported.ui) {
                ...
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !d.textTracks) u.is.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && T.setCaptionsMenu.call(this); else {
                    ...
                    if (!u.is.empty(i)) {
                        if (u.getBrowser().isIE && window.URL) {
                            ...
                            Array.from(n).forEach(function (e) {
                                var t = e.getAttribute("src"), i = u.parseUrl(t);
            ...
            var e = this, t = b.getTracks.call(this);
            ...
            var t = u.is.event(e) ? e.target : e, i = t.activeCues, n = i.length && i[0];
        ...
        addStyleHook: function () {
            ...
            var i = u.is.number(t) ? t : 0, n = u.is.element(e) ? e : this.elements.display.buffer;
            if (u.is.element(n)) {
                n.value = i;
                    ...
                    get: function () {
                        ...
                        if (!u.is.empty(i)) {
                            ...
                            if (!u.is.empty(n)) {
                                ...
                                if (!u.is.empty(s)) {
                                    u.dispatchEvent.call(e, e.media, "qualityrequested", !1, {quality: t});
                                    var a = e.currentTime, l = e.playing;
                                    e.media.src = s[0].getAttribute("src"), e.media.load(), l && e.play(), e.currentTime = a, u.dispatchEvent.call(e, e.media, "qualitychange", !1, {quality: t})
                                }
                            }
                        }
                    }
        ...
        updateRangeFill: function (e) {
            ...
            var i = T.getIconUrl.call(this), n = (i.absolute ? "" : i.url) + "#" + this.config.iconPrefix,
                s = document.createElementNS("http://www.w3.org/2000/svg", "svg");
            u.setAttributes(s, u.extend(t, {role: "presentation", focusable: "false"}));
            var a = document.createElementNS("http://www.w3.org/2000/svg", "use"), l = n + "-" + e;
            ...
            var i = v(e, this.config), n = Object.assign({}, t);
            switch (e) {
                case"pip":
                    i = "PIP";
                    break;
            ...
            if (u.is.empty(e)) return null;
            var t = u.createElement("span", {class: this.config.classNames.menu.value});
            return t.appendChild(u.createElement("span", {class: this.config.classNames.menu.badge}, e)), t
        }, createButton: function (e, t) {
            var i = u.createElement("button"), n = Object.assign({}, t), s = u.toCamelCase(e), a = !1, l = void 0,
            ...
            return a ? (i.appendChild(T.createIcon.call(this, c, {class: "icon--pressed"})), i.appendChild(T.createIcon.call(this, r, {class: "icon--not-pressed"})), i.appendChild(T.createLabel.call(this, o, {class: "label--pressed"})), i.appendChild(T.createLabel.call(this, l, {class: "label--not-pressed"})), n["aria-pressed"] = !1) : (i.appendChild(T.createIcon.call(this, r)), i.appendChild(T.createLabel.call(this, l))), u.extend(n, u.getAttributesFromSelector(this.config.selectors.buttons[s], n)), u.setAttributes(i, n), "play" === s ? (u.is.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(i)) : this.elements.buttons[s] = i, i
            ...
            return this.elements.inputs[e] = n, T.updateRangeFill.call(this, n), {label: i, input: n}
            ...
            var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : null,
                a = arguments.length > 5 && void 0 !== arguments[5] && arguments[5], l = u.createElement("li"),
                r = u.createElement("label", {class: this.config.classNames.control}),
            ...
            if (this.config.tooltips.seek && u.is.element(this.elements.inputs.seek) && u.is.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                var i = 0, n = this.elements.inputs.seek.getBoundingClientRect(),
            ...
            var n = this.elements.settings.panes[e], s = null, a = t;
            switch (e) {
                case"captions":
            ...
            var e = this, t = this.elements.settings.panes.captions.querySelector("ul"),
            ...
            if (T.toggleTab.call(this, "captions", i), u.emptyElement(t), T.checkMenu.call(this), i) {
                var n = b.getTracks.call(this).map(function (t) {
                    return {language: u.is.empty(t.language) ? "enabled" : t.language, label: b.getLabel.call(e, t)}
                });
                n.unshift({language: "", label: v("disabled", this.config)}), n.forEach(function (i) {
            ...
            var e = this.elements.settings.tabs, t = !u.is.empty(e) && Object.values(e).some(function (e) {
                return !e.hidden
            });
            u.toggleHidden(this.elements.settings.menu, !t)
        }, toggleMenu: function (e) {
            var t = this.elements.settings.form, i = this.elements.buttons.settings;
            if (u.is.element(t) && u.is.element(i)) {
                var n = u.is.boolean(e) ? e : u.is.element(t) && t.hasAttribute("hidden");
                if (u.is.event(e)) {
                    var s = u.is.element(t) && t.contains(e.target), a = e.target === this.elements.buttons.settings;
                    if (s || !s && !a && n) return;
                    a && e.stopPropagation()
                }
            ...
            return u.removeElement(t), {width: i, height: n}
        }, showTab: function (e) {
            var t = this.elements.settings.menu, i = e.target, n = "false" === i.getAttribute("aria-expanded"),
                s = document.getElementById(i.getAttribute("aria-controls"));
            if (u.is.element(s) && "tabpanel" === s.getAttribute("role")) {
                var a = t.querySelector('[role="tabpanel"]:not([hidden])'), l = a.parentNode;
            ...
            if (this.config.controls.includes("restart") && i.appendChild(T.createButton.call(this, "restart")), this.config.controls.includes("rewind") && i.appendChild(T.createButton.call(this, "rewind")), this.config.controls.includes("play") && i.appendChild(T.createButton.call(this, "play")), this.config.controls.includes("fast-forward") && i.appendChild(T.createButton.call(this, "fast-forward")), this.config.controls.includes("progress")) {
                var n = u.createElement("div", u.getAttributesFromSelector(this.config.selectors.progress)),
                    s = T.createRange.call(this, "seek", {id: "plyr-seek-" + e.id});
                if (n.appendChild(s.label), n.appendChild(s.input), n.appendChild(T.createProgress.call(this, "buffer")), this.config.tooltips.seek) {
                    var a = u.createElement("span", {role: "tooltip", class: this.config.classNames.tooltip}, "00:00");
            ...
            if (this.config.controls.includes("current-time") && i.appendChild(T.createTime.call(this, "currentTime")), this.config.controls.includes("duration") && i.appendChild(T.createTime.call(this, "duration")), this.config.controls.includes("mute") && i.appendChild(T.createButton.call(this, "mute")), this.config.controls.includes("volume")) {
                var l = u.createElement("div", {class: "plyr__volume"}),
                    r = {max: 1, step: .05, value: this.config.volume},
                    o = T.createRange.call(this, "volume", u.extend(r, {id: "plyr-volume-" + e.id}));
            ...
            if (this.config.controls.includes("captions") && i.appendChild(T.createButton.call(this, "captions")), this.config.controls.includes("settings") && !u.is.empty(this.config.settings)) {
                ...
                var p = u.createElement("form", {
                    ...
                    role: "tablist",
                    tabindex: -1
                }), h = u.createElement("div"), m = u.createElement("div", {
                    id: "plyr-settings-" + e.id + "-home",
                    "aria-labelled-by": "plyr-settings-toggle-" + e.id,
                    role: "tabpanel"
                }), g = u.createElement("ul", {role: "tablist"});
                this.config.settings.forEach(function (i) {
                    var n = u.createElement("li", {role: "tab", hidden: ""}),
                        s = u.createElement("button", u.extend(u.getAttributesFromSelector(t.config.selectors.buttons.settings), {
                            ...
                            "aria-expanded": !1
                        }), v(i, t.config)), a = u.createElement("span", {class: t.config.classNames.menu.value});
        ...
        return r(e, [{
            key: "handleKey", value: function (e) {
                var t = this, i = e.keyCode ? e.keyCode : e.which, n = "keydown" === e.type,
                    s = n && i === this.lastKey;
            ...
            key: "media", value: function () {
                ...
                this.player.supported.ui && this.player.config.disableContextMenu && u.on(this.player.elements.wrapper, "contextmenu", function (e) {
                    ...
                    T.updateSetting.call(e.player, "speed"), e.player.storage.set({speed: e.player.speed})
                    ...
                    T.updateSetting.call(e.player, "captions"), e.player.storage.set({language: e.player.language})
                }), u.on(this.player.media, "captionsenabled captionsdisabled", function () {
                    T.updateSetting.call(e.player, "captions"), e.player.storage.set({captions: e.player.captions.active})
            ...
            key: "controls", value: function () {
                var e = this, t = A.isIE ? "change" : "input", i = function (t, i, n) {
                    var s = e.player.config.listeners[n], a = !0;
                    ...
                    var l = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4],
                        r = e.player.config.listeners[a], o = u.is.function(r);
                    u.on(t, n, function (e) {
                        return i(e, s, a)
                    }, l && !o)
                };
                n(this.player.elements.buttons.play, "click", this.player.togglePlay, "play"), n(this.player.elements.buttons.restart, "click", this.player.restart, "restart"), n(this.player.elements.buttons.rewind, "click", this.player.rewind, "rewind"), n(this.player.elements.buttons.fastForward, "click", this.player.forward, "fastForward"), n(this.player.elements.buttons.mute, "click", function () {
                    ...
                    var i = t.webkitDirectionInvertedFromDevice, n = 0;
        ...
        return r(e, [{
            ...
            key: "onAdsManagerLoaded", value: function (e) {
                var t = this, i = new google.ima.AdsRenderingSettings;
                    ...
                    if (0 !== e && -1 !== e && e < t.player.duration) {
                        ...
                        if (u.is.element(i)) {
                            var n = 100 / t.player.duration * e,
                                s = u.createElement("span", {class: t.player.config.classNames.cues});
    ...
    var P = {
        setup: function () {
            ...
            if (u.is.empty(t) || !t.startsWith("youtube-")) {
                ...
                var n = u.parseYouTubeId(i), s = u.generateId(e.provider), a = u.createElement("div", {id: s});
                        ...
                        onError: function (t) {
                            ...
                            P.getTitle.call(e, n), e.media.play = function () {
                                ...
                                get: function () {
                                    ...
                                    var n = t;
                                    i.setPlaybackQuality(x(n)), u.dispatchEvent.call(e, e.media, "qualityrequested", !1, {quality: n})
                                }
                            });
        ...
        setup: function () {
            ...
            var t = u.is.string(e) ? e.split(":") : this.config.ratio.split(":"), i = 100 / t[0] * t[1];
            ...
            }, n = u.buildUrlParams(i), s = t.media.getAttribute("src");
            u.is.empty(s) && (s = t.media.getAttribute(this.config.attributes.embed.id));
            var a = u.parseVimeoId(s), l = u.createElement("iframe"),
            ...
            Object.defineProperty(t.media, "currentTime", {
                get: function () {
                    ...
                    t.media.seeking = !0, u.dispatchEvent.call(t, t.media, "seeking"), t.embed.setCurrentTime(e).catch(function () {
                    }), i && t.pause()
                }
            });
        ...
        setup: function () {
            if (this.media) if (u.toggleClass(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0), u.toggleClass(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0), this.isEmbed && u.toggleClass(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0), this.supported.ui && (u.toggleClass(this.elements.container, this.config.classNames.pip.supported, d.pip && this.isHTML5 && this.isVideo), u.toggleClass(this.elements.container, this.config.classNames.airplay.supported, d.airplay && this.isHTML5), u.toggleClass(this.elements.container, this.config.classNames.stopped, this.config.autoplay), u.toggleClass(this.elements.container, this.config.classNames.isIos, M.isIos), u.toggleClass(this.elements.container, this.config.classNames.isTouch, this.touch)), this.isVideo && (this.elements.wrapper = u.createElement("div", {class: this.config.classNames.video}), u.wrap(this.media, this.elements.wrapper)), this.isEmbed) switch (this.provider) {
                case"youtube":
                    P.setup.call(this);
                    break;
                case"vimeo":
                    L.setup.call(this)
            } else this.isHTML5 && (k.setTitle.call(this), w.extend.call(this)); else this.debug.warn("No media element found!")
        }
    }, q = {
        insertElements: function (e, t) {
            var i = this;
            u.is.string(t) ? u.insertElement(e, this.media, {src: t}) : u.is.array(t) && t.forEach(function (t) {
            ...
            u.is.object(t) && "sources" in t && t.sources.length ? (w.cancelRequests.call(this), this.destroy.call(this, function () {
                switch (i.options.quality = [], u.removeElement(i.media), i.media = null, u.is.element(i.elements.container) && i.elements.container.removeAttribute("class"), i.type = t.type, i.provider = u.is.empty(t.sources[0].provider) ? e.html5 : t.sources[0].provider, i.supported = d.check(i.type, i.provider, i.config.playsinline), i.provider + ":" + i.type) {
                    ...
                    case"youtube:video":
                    case"vimeo:video":
                        i.media = u.createElement("div", {src: t.sources[0].src})
                }
    ...
    return function () {
        function n(s, a) {
            ...
            if (l(this, n), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = d.touch, this.media = s, u.is.string(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || u.is.nodeList(this.media) || u.is.array(this.media)) && (this.media = this.media[0]), this.config = u.extend({}, i, a || {}, function () {
                ...
                quality: [],
                captions: []
            }, this.debug = new h(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", d), !u.is.nullOrUndefined(this.media) && u.is.element(this.media)) if (this.media.plyr) this.debug.warn("Target already setup"); else if (this.config.enabled) if (d.check().api) {
                setTimeout(function () {
                    var e = r.media.cloneNode(!0);
                    e.getAttribute("autoplay") && e.pause(), r.elements.original = e
                }, 0);
                var o = this.media.tagName.toLowerCase(), c = null, p = null, m = null;
                switch (o) {
                    case"div":
        ...
        return r(n, [{
            ...
            key: "toggleControls", value: function (e) {
                ...
                if (u.is.element(this.elements.controls) && this.supported.ui && !this.isAudio) {
                    var i = 0, n = e, s = !1;
                    if (!u.is.boolean(e)) if (u.is.event(e)) {
            ...
            key: "duration", get: function () {
                var e = parseFloat(this.config.duration), t = this.media ? Number(this.media.duration) : 0;
